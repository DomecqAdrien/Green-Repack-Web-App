...
@Component({
  selector: 'app-vente-en-attente-produit',
  templateUrl: './vente-en-attente-produit.component.html',
  styleUrls: ['./vente-en-attente-produit.component.scss']
})
export class VenteEnAttenteProduitComponent implements OnInit {
